...
public class MainVerticle extends AbstractVerticle {
  ...
  private void handleDashboard(RoutingContext ctx) {
    ...
    jdbcClient.query("SELECT id, nom, role, avatar_url, date_creation FROM users WHERE role='ingenieur'", res -> {
      if (res.succeeded()) {
  ...
  private void handleGetCreator(RoutingContext ctx) {
    ...
    jdbcClient.queryWithParams(
      "SELECT id, nom, role, avatar_url, TO_CHAR(date_creation, 'YYYY-MM-DD') as date_creation FROM users WHERE id = ? AND role='ingenieur'",
